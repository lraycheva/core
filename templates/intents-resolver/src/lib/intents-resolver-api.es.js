...
class GlueController {
    initialize(glue) {
        return __awaiter(this, void 0, void 0, function* () {
            validateGlue(glue);
            this.glue = glue;
            const context = yield this.glue.appManager.myInstance.getContext();
    ...
    sendInteropMethodResponse(handler) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    subscribeOnInstanceStarted(callback) {
        return this.glue.appManager.onInstanceStarted((inst) => __awaiter(this, void 0, void 0, function* () {
            const currentIntentDef = yield this.extractCurrentIntentInfoFromApp(inst.application);
            if (!currentIntentDef) {
                return;
            }
    ...
    subscribeOnInstanceStopped(callback) {
        return this.glue.appManager.onInstanceStopped((inst) => __awaiter(this, void 0, void 0, function* () {
            const currentIntentDef = yield this.extractCurrentIntentInfoFromApp(inst.application);
            if (!currentIntentDef) {
                return;
            }
    ...
    subscribeOnAppAdded(callback) {
        return this.glue.appManager.onAppAdded((app) => __awaiter(this, void 0, void 0, function* () {
            const currentIntentDef = yield this.extractCurrentIntentInfoFromApp(app);
            if (!currentIntentDef) {
                return;
            }
    ...
    subscribeOnAppRemoved(callback) {
        return this.glue.appManager.onAppRemoved((app) => __awaiter(this, void 0, void 0, function* () {
            const currentIntentDef = yield this.extractCurrentIntentInfoFromApp(app);
            if (!currentIntentDef) {
                return;
            }
    ...
    subscribeForServerMethodAdded(handler) {
        const responsePromise = new Promise((resolve, reject) => {
            const unsub = this.glue.interop.serverMethodAdded(({ server, method }) => __awaiter(this, void 0, void 0, function* () {
                if (server.instance !== this._callerId || method.name !== this._methodName) {
                    return;
                }
                try {
                    const invocationRes = yield this.glue.interop.invoke(this._methodName, { intent: this.intent, handler }, { instance: this._callerId });
    ...
    extractCurrentIntentInfoFromApp(app) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let intentDef;
            if (window.glue42core) {
                intentDef = (_a = app.userProperties.intents) === null || _a === void 0 ? void 0 : _a.find((intent) => intent.name === this.intent);
            }
            if (window.glue42gd) {
                let apps;
                try {
                    const result = yield this.glue.interop.invoke("T42.ACS.GetApplications", { withIntentsInfo: true });
                    apps = result.returned.applications;
                }
                catch (error) {
                    return;
                }
                intentDef = apps.find(appDef => { var _a; return appDef.name === app.name && ((_a = appDef.intents) === null || _a === void 0 ? void 0 : _a.find(intent => intent.name === this.intent)); });
            }
            return intentDef;
        });
    }
    buildIntentHandler(app, intentDef, instanceId) {
        return {
    ...
    buildRemovedIntentHandler(app, instanceId) {
        return {
            applicationName: app.name,
            type: instanceId ? "instance" : "app",
            instanceId
...
const factoryFunction = (glue) => __awaiter(void 0, void 0, void 0, function* () {
    const ioc = new IoC();
    try {
        yield ioc.glueController.initialize(glue);
    }
    catch (error) {
...
if (typeof window !== "undefined") {
    window.GlueIntentsResolver = factoryFunction;
}
