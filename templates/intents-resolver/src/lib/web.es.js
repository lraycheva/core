...
class IntentsController {
    ...
    createResponsePromise(intent, instance, methodName) {
        let resolve = () => { };
        let reject = () => { };
        ...
        this.intentsResolverResponsePromises[instance.id] = { intent, resolve, reject, promise, methodName, instance };
    }
    resolverResponseHandler(args, callerId) {
        ...
        if (!response.ok) {
            ...
            const { reject, instance } = this.intentsResolverResponsePromises[instanceId];
            reject(response.error.message);
            instance.stop().catch((err) => this.logger.error(err));
            return;
        }
    ...
    openIntentResolverApplication(requestObj, methodName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.createResponsePromise(requestObj.intent, instance, methodName);
            return instance;
        });
    }
